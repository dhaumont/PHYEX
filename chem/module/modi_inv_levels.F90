...
!     ########################
INTERFACE
      SUBROUTINE  INV_LEVELS(KIDIA,KFDIA,KLON,KLEV,KINCR,PARRAYALD,  &
                                  PARRAYMNH)
...
REAL(KIND=JPRB), DIMENSION(KLON,KLEV),   INTENT(INOUT) :: PARRAYALD  ! Aladin type arry
REAL(KIND=JPRB), DIMENSION(KLON,KLEV+2), INTENT(INOUT) :: PARRAYMNH  ! MNH type array
